...
#
# neu.tcl: Tcl script for re-creating project 'Testing_Platform'
#
# Generated by Vivado on Tue Mar 12 21:26:00 CET 2019
...
#
# 1. This project restoration tcl script (neu.tcl) that was generated.
#
...
set files [list \
 "[file normalize "$origin_dir/Testing_Platform.srcs/sources_1/imports/hdl/bd_name_wrapper.vhd"]"\
]
...
set file "[file normalize "$origin_dir/Testing_Platform.srcs/constrs_1/par.xdc"]"
...
import_files -of_objects [get_reconfig_modules BLANK] $files
...
set_property pr_configuration config_2 [get_runs impl_1]
...
if {[string equal [get_runs -quiet child_0_impl_1] ""]} {
      create_run -name child_0_impl_1 -part xc7z020clg400-1 -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -pr_config config_1 -constrset constrs_1 -parent_run impl_1
} else {
